...
mod test {
    ...
    use soroban_sdk::{bytesn, testutils::Ledger, token::TokenClient, Address, Env};
    ...
    fn test() {
        ...
        e.ledger().set_network_id(bytes_lit::bytes!(0x7ac33997544e3175d266bd022439b22cdb16508c01163f26e5cb2a3e1045a979));
        let a = e.register_native();
